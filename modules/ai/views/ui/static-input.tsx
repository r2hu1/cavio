    ...
    >
      <div className="relative bg-sidebar dark:bg-card border rounded-xl shadow-lg">
        <Textarea
          ...
          placeholder={"Start writing your cool prompt..."}
          className="w-full px-4 py-3 resize-none bg-transparent! border-0! shadow-none! dark:text-white text-sm focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-neutral-500 placeholder:text-sm min-h-[70px]"
        />
